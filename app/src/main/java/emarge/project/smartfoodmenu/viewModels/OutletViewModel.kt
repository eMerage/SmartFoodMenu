...
class OutletViewModel : ViewModel() {
    ...
    fun onAddOutletClick() {
        ...
        when {
            ...
            longitude.value == 0.0  -> outletAddingError.value = "Please refresh the location"
            latitude.value == null -> outletAddingError.value = "Please refresh the location"
            longitude.value == null -> outletAddingError.value = "Please refresh the location"
